...
public class CombineGroupByOrderByOperatorSimple extends BaseOperator<IntermediateResultsBlock> {
  private static final Logger LOGGER = LoggerFactory.getLogger(CombineGroupByOrderByOperatorSimple.class);
  ...
  public CombineGroupByOrderByOperatorSimple(List<Operator> operators, BrokerRequest brokerRequest) {
