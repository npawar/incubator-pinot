...
import org.apache.pinot.core.operator.query.AggregationGroupByOperatorV1;
...
public class AggregationGroupByPlanNodeV2 implements PlanNode {
  ...
  public AggregationGroupByOperatorV2 run() {
    ...
    return new AggregationGroupByOperatorV2(_aggregationInfos, _functionContexts, _groupBy, _orderBy, _numGroupsLimit,
