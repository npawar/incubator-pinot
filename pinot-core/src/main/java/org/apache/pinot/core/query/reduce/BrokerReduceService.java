...
public class BrokerReduceService implements ReduceService<BrokerResponseNative> {
   ...
   * @param dataTableMap map from server to data table
   */
  private void setSQLGroupByOrderByResults(@Nonnull BrokerResponseNative brokerResponseNative,
      @Nonnull DataSchema dataSchema, @Nonnull List<AggregationInfo> aggregationInfos, @Nonnull GroupBy groupBy,
      @Nonnull List<SelectionSort> orderBy, @Nonnull Map<ServerInstance, DataTable> dataTableMap,
   ...
   * @param dataTableMap map from server to data table
   */
  private void setPQLGroupByOrderByResults(@Nonnull BrokerResponseNative brokerResponseNative,
      @Nonnull DataSchema dataSchema, @Nonnull List<AggregationInfo> aggregationInfos, @Nonnull GroupBy groupBy,
      @Nonnull List<SelectionSort> orderBy, @Nonnull Map<ServerInstance, DataTable> dataTableMap,
      boolean preserveType) {
