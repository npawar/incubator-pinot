...
import org.apache.pinot.core.segment.index.loader.defaultcolumn.AutoGeneratedColumnHandler;
  ...
  public void process()
    ...
    try (SegmentDirectory.Writer segmentWriter = _segmentDirectory.createWriter()) {
      ...
      if (_schema != null) {
        ...
        AutoGeneratedColumnHandler autoGeneratedColumnHandler =
            new AutoGeneratedColumnHandler(_indexDir, _schema, _tableConfig, _segmentMetadata, segmentWriter,
                _indexLoadingConfig);
        autoGeneratedColumnHandler.updateColumns();
