...
public class V3DefaultColumnHandler extends BaseDefaultColumnHandler {
  ...
  public V3DefaultColumnHandler(File indexDir, Schema schema, SegmentMetadataImpl segmentMetadata,
    ...
    super(indexDir, schema, segmentMetadata, segmentWriter, indexLoadingConfig);
  }

  @Override
  public void updateDefaultColumn(String column, AutoGeneratedColumnHandler.ColumnAction action)
      throws Exception {
