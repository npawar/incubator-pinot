...
public class BaseAutoGeneratedColumnHandlerTest {
  ...
  public void testComputeDefaultColumnActionMapForCommittedSegment() {
    ...
    AutoGeneratedColumnHandler columnHandler =
        new AutoGeneratedColumnHandler(segmentDirectory, schema0, committedSegmentMetadata, writer, indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(), Collections.EMPTY_MAP);
    ...
    Schema schema1 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema1, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(),
    ...
    Schema schema2 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema2, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(),
        ImmutableMap.of("column11", DefaultColumnAction.ADD_DIMENSION));
    ...
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema3, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(),
    ...
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema4, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(),
    ...
    Schema schema5 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema5, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(), Collections.EMPTY_MAP);
    ...
    Schema schema6 =
        new Schema.SchemaBuilder().setSchemaName("testTable").addSingleValueDimension("column1", FieldSpec.DataType.INT)
            ...
            .addSingleValueDimension("daysSinceEpoch", FieldSpec.DataType.INT)
            .addSingleValueDimension("weeksSinceEpochSunday", FieldSpec.DataType.INT).build();
    columnHandler = new V3DefaultColumnHandler(segmentDirectory, schema6, committedSegmentMetadata, writer,
        indexLoadingConfig);
    Assert.assertEquals(columnHandler.computeColumnActionMap(), Collections.EMPTY_MAP);
  }
}
