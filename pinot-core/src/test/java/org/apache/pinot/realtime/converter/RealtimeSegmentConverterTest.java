...
public class RealtimeSegmentConverterTest {
  ...
  public void testNoVirtualColumnsInSchema() {
    ...
    schema.addField(new DateTimeFieldSpec("time", FieldSpec.DataType.LONG, "1:MILLISECONDS:EPOCH", "1:MILLISECONDS"));
    TableConfig tableConfig =
        new TableConfigBuilder(TableType.REALTIME).setTableName("test").setTimeColumnName("time").build();
